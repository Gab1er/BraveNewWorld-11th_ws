...
var s_account = "hboqa";
if (loc === 'www.discoverwestworld.com' || loc === 'discoverwestworld.com') {
  s_account = "hboprod";
}
...
// s.visitor=Visitor.getInstance("3292419354F99C9C0A4C98A4@AdobeOrg")
s.visitorNamespace="hbo";
/************************** CONFIG SECTION **************************/
...
s.linkInternalFilters="javascript:," + window.location.hostname; //optional: add your internal domain here
...
function s_doPlugins(s) {
  ...
  //s.eVar42=s_getLoadTime();
    s.campaign = s.Util.getQueryParam("camp");
  //s.prop2=s.getDaysSinceLastVisit(Cookie_Name);
...
s.trackingServer="matrix.hbo.com"
s.trackingServerSecure="smatrix.hbo.com"
